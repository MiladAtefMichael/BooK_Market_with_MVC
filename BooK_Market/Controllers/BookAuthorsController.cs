...
namespace BooK_Market.Controllers
{
    public class BookAuthorsController : Controller
    {
        ...
        public BookAuthorsController(DB context)
        {
            _context = context;
        }
        ...
        {
            var dB = _context.BookAuthors.Include(b => b.Author).Include(b => b.Book);
        ...
        {
            ViewData["AuthId"] = new SelectList(_context.Authors, "AutId", "Name");
        ...
        public async Task<IActionResult> Create([Bind("BookId,AuthId,Order")] BookAuthor bookAuthor)
        {
            ...
            ViewData["AuthId"] = new SelectList(_context.Authors, "AutId", "Name", bookAuthor.AuthId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,AuthId,Order")] BookAuthor bookAuthor)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DB.BookAuthors'  is null.");
            }
            var bookAuthor = await _context.BookAuthors.FindAsync(id);
            if (bookAuthor != null)
            {
